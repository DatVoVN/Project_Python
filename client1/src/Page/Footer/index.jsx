        ...
        <div class='container px-5'>
          <div class='grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-6'>
            ...
            <div class='col-span-1'>
              ...
              <ul class='grid gap-2'>
                <li>
                  <a title='Về chúng tôi' class='transition-all hover:text-primary' href='#' previewlistener='true'>
                    Về chúng tôi
                  </a>
                </li>
                <li>
                  <a title='Liên hệ' class='transition-all hover:text-primary' href='#' previewlistener='true'>
                    Liên hệ
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a title='Cơ hội việc làm' class='transition-all hover:text-primary' href='#' previewlistener='true'>
                    Cơ hội việc làm
                  </a>
                </li>
                <li>
                  <a title='Quy định bảo mật' class='transition-all hover:text-primary' href='#' previewlistener='true'>
                    Quy định bảo mật
                  </a>
                </li>
                <li>
            ...
            <div class='col-span-1'>
              ...
              <ul class='grid gap-2'>
                ...
                <li>
                  <a title='Tạo CV' class='transition-all hover:text-primary' href='#' previewlistener='true'>
                    Tạo CV
                  </a>
                </li>
                <li>
            ...
            <div class='col-span-1'>
              ...
              <ul class='grid gap-2'>
                <li>
                  <a title='Đăng việc làm IT' class='transition-all hover:text-primary' href='#' previewlistener='true'>
                    Đăng việc làm IT
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a title='Tạo tài khoản' class='transition-all hover:text-primary' href='#' previewlistener='true'>
                    Tạo tài khoản
                  </a>
                </li>
              </ul>
